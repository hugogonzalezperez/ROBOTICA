...
th = [    0,   p[1],     -90,     -90,     p[3],(90-p[4]),(90+p[4]),      90]
a  = [    0,      5,       0,       0,        0,       -2,       -2,       -2]
...
T2I=matriz_T(d[2],th[2],a[2],al[2])
T0I=np.dot(T02,T2I)

TI3=matriz_T(d[3],th[3],a[3],al[3])
T03=np.dot(T0I,TI3)
...
muestra_origenes([o00, o10, o20, o230, o30,o40,[[o510], [o520]]], oEF0)
muestra_robot   ([o00, o10, o20, o230, o30,o40,[[o510], [o520]]], oEF0)
input()
